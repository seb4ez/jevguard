...
Operates via the local Python runtime (`jevguard`) or the Model Context Protocol server (`jevguard-mcp`: [github.com/seb4ez/jevguard-mcp](https://github.com/seb4ez/jevguard-mcp)).
